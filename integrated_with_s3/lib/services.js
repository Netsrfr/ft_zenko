...
const ConID = authInfo.getCanonicalID();
console.log("ENTRYPOINT");
execFile('java', ['-cp', '/home/linuxbrew/kafka/kafka_2.11-0.11.0.0/libs/*:.', 'NewObjNotifier', 'metatag', objectKey, bucketName, ConID, log, bucketName], (error, stdout, stderr) => {
